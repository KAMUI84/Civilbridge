...
const styles = {
  ...
  focusCard: { display: 'grid', gap: 12, border: '1px solid #e8eef5', borderRadius: 18, padding: 16, background: '#f8fbff' },
  ...
  reviewCard: { display: 'grid', gap: 12, border: '1px solid #e8eef5', borderRadius: 18, padding: 14, background: '#ffffff' },
  ...
  textarea: { width: '100%', padding: '11px 12px', borderRadius: 12, border: '1px solid #e6ecf4', background: '#ffffff', color: 'var(--text-color)', resize: 'vertical', fontFamily: 'inherit' },
  ...
  select: { padding: '10px 12px', borderRadius: 12, border: '1px solid #e6ecf4', background: '#ffffff', color: 'var(--text-color)' },
  input: { padding: '10px 12px', borderRadius: 12, border: '1px solid #e6ecf4', background: '#ffffff', color: 'var(--text-color)' },
