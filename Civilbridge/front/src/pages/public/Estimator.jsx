              ...
              {activeMethod === "upload" && (
                <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-12 text-center mb-6 hover:border-emerald-500 transition-colors cursor-pointer">
                    <input type="file" accept=".pdf,.dwg,.dxf,.jpg,.png" className="hidden" id="plan-upload" />
                    <label htmlFor="plan-upload" className="flex flex-col items-center justify-center gap-4 cursor-pointer">
                      <Upload className="h-8 w-8 text-gray-400" />
                      <span className="text-gray-600">Click to upload your architectural plans or sketches</span>
                      <span className="text-sm text-gray-400">Supported formats: PDF, DWG, DXF, JPG, PNG</span>
                    </label>
                  </div>
