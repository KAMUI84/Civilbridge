    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            'shadow-input flex h-10 w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 transition duration-400 group-hover/input:shadow-none file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-slate-400 focus-visible:ring-[2px] focus-visible:ring-blue-300 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
            className
          )}
          ref={ref}
          {...props}
        ...
        return (
          <span
            ...
            style={{
              ...
              borderStyle,
              borderWidth: '1px',
              borderColor: `rgba(var(--foreground), ${borderOpacity / 100})`,
              top: '50%',
              left: '50%',
  ...
  return (
    <>
      ...
      <section
        ...
        className={cn(
          'absolute flex size-full transform-gpu animate-orbit items-center justify-center rounded-full border bg-black/5 [animation-delay:calc(var(--delay)*1000ms)]',
...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
  ...
  return (
    <section className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg">
      <span className="pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-slate-900 to-slate-300/80 bg-clip-text text-center text-7xl font-semibold leading-none text-transparent">
        {text}
      </span>
  ...
  return (
    <section className="max-md:w-full flex flex-col gap-4 w-96 mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <button
            className="bg-gradient-to-br relative group/btn from-blue-600 to-blue-500 block w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_rgba(255,255,255,0.22)_inset,0px_-1px_0px_0px_rgba(37,99,235,0.18)_inset] outline-hidden hover:cursor-pointer"
            type="submit"
          >
            {submitButton} &rarr;
            <BottomGradient />
