...
const styles = {
  ...
  freshWorkspaceCard: { border: '1px solid #e8eef5', borderRadius: 24, padding: 22, background: 'var(--card-bg)', display: 'grid', gap: 14, boxShadow: '0 14px 28px rgba(15,23,42,0.05)' },
  ...
  kpiCard: { border: '1px solid #e8eef5', borderRadius: 20, padding: 16, background: 'var(--card-bg)', display: 'grid', gap: 8, boxShadow: '0 10px 22px rgba(15,23,42,0.05)' },
  ...
  sectionCard: { border: '1px solid #e8eef5', borderRadius: 22, padding: 18, background: 'var(--card-bg)', display: 'grid', gap: 14, boxShadow: '0 14px 28px rgba(15,23,42,0.05)' },
  ...
  select: { minWidth: 220, padding: '10px 12px', borderRadius: 12, border: '1px solid #e6ecf4', background: 'var(--card-bg)', color: 'var(--text-color)' },
  stack: { display: 'grid', gap: 14 },
  progressCard: { border: '1px solid #e8eef5', borderRadius: 18, padding: 14, background: 'var(--surface-bg)', display: 'grid', gap: 12 },
  ...
  phaseRow: { display: 'flex', justifyContent: 'space-between', gap: 14, alignItems: 'center', border: '1px solid #e8eef5', borderRadius: 16, padding: 12, background: 'var(--card-bg)' },
  ...
  paymentRow: { display: 'flex', justifyContent: 'space-between', gap: 14, alignItems: 'center', border: '1px solid #e8eef5', borderRadius: 16, padding: 12, background: 'var(--card-bg)' },
  projectRow: { display: 'flex', justifyContent: 'space-between', gap: 14, alignItems: 'center', border: '1px solid #e8eef5', borderRadius: 16, padding: 12, background: 'var(--card-bg)', textAlign: 'left', color: 'inherit' },
  ...
  stateCard: { minHeight: 280, border: '1px solid #e8eef5', borderRadius: 24, background: 'var(--card-bg)', display: 'grid', placeItems: 'center', textAlign: 'center', padding: 24, gap: 12, boxShadow: '0 14px 28px rgba(15,23,42,0.05)' },
