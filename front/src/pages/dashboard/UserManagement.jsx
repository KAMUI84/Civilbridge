...
export default function UserManagement() {
  ...
  const confirmRoleChange = useCallback(async () => {
    ...
    try {
      ...
      await rolesService.assignRole({ userId: selectedUser.id, role: selectedUser.newRole });
            ...
            {roleModalLoading ? (
              ...
              <>
                ...
                <select
                  ...
                  onChange={(event) => setSelectedUser((current) => current ? { ...current, newRole: event.target.value } : current)}
