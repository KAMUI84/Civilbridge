...
import { isAuthed, getUser, logout as storeLogout } from "../../store/authStore";
...
export default function Navbar() {
  ...
  useEffect(() => {
    const sync = () => setSessionTick((x) => x + 1);
  ...
  return (
    <>
      ...
      {/* Hidden tick for forced re-render on auth changes */}
      <span style={{ display: "none" }}>{sessionTick}</span>
    </>
  );
}
