...
function ExecutiveCard({ label, value, sub, accent }) {
  return (
    <div style={{ ...styles.executiveCard, background: `radial-gradient(circle at top right, ${accent}14, transparent 42%), linear-gradient(180deg, #ffffff, #f8fbff)` }}>
...
const styles = {
  ...
  heroEyebrow: { fontSize: 11, fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.2em', color: '#2563eb' },
  heroTitle: { margin: 0, fontSize: 'clamp(30px, 4.3vw, 50px)', color: '#0f172a', lineHeight: 1.03, maxWidth: 760 },
  heroText: { margin: 0, color: '#64748b', lineHeight: 1.7, maxWidth: 760, fontSize: 15 },
  ...
  heroSignalLabel: { fontSize: 12, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700 },
  heroSignalValue: { fontSize: 22, color: '#0f172a' },
  railCard: {
    borderRadius: 22,
    padding: 18,
    border: '1px solid #e8eef5',
  ...
  railLabel: { fontSize: 12, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700 },
  railValue: { fontSize: 26, color: '#0f172a', fontWeight: 800 },
  railHint: { fontSize: 13, color: '#64748b' },
  ...
  executiveLabel: { fontSize: 12, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 700 },
  executiveValue: { fontSize: 30, color: '#0f172a', fontWeight: 800 },
  executiveSub: { fontSize: 13, color: '#64748b', lineHeight: 1.5 },
