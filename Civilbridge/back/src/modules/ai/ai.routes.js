...
router.get("/providers", aiRateLimit, getProviders);
router.post("/analyze-plan", aiRateLimit, planUpload.single("file"), analyzePlan);
router.post("/generate-plan", aiRateLimit, generatePlan);
router.post("/estimate", aiRateLimit, estimateProject);
